...
Original file is located at
    https://colab.research.google.com/drive/1YdatYEdlnDOPB-PMM44OU-IxYLdsn6kL
...
preferred_name = "Boris Polania" #@param {type:"string"}
...
name_pronunciation = "Boris Polania" #@param {type:"string"}
...
full_name = "Boris Polania Castro\"" #@param {type:"string"}
...
HUID = "21400866" #@param {type:"string"}
...
harvard_email = "bpolania@g.harvard.edu" #@param {type:"string"}
...
personal_email = "boris.polania@gmail.com" #@param {type:"string"}
...
linkedin = "https://www.linkedin.com/in/bpolania/" #@param {type:"string"}
...
previous_classes = "I have a bachelors degree in Harvard major in Economics, Minor in CS and Finance" #@param {type:"string"}

#@title Highest Education
#@markdown `highest_education` (1 pt): What is your highest education. Select the option that best applies.
highest_education = "Completed Bachelor's" #@param ["", "In high school", "Completed high school", "In college", "Completed Bachelor's", "Completed Master's", "Completed Professional Degree (MD, MBA, EdD, JD, etc.)", "Completed PhD", "Currently in Master's/Professional Degree/PhD program"]

#@title Current Occupation
#@markdown `current_occupation` (1 pt): What is your current occupation?
current_occupation = "Software Engineer" #@param {type:"string"}
...
current_city = "Santa Clara, CA" #@param {type:"string"}
...
hardware_experience = "I have designed hardware, I have developed firmware, I have worked with Raspberry Pi, Arduino, Jetson" #@param {type:"string"}
...
software_experience = "15+ years workings as a software engineer" #@param {type:"string"}
...
advanced_math = False #@param {type:"boolean"}
programming = True #@param {type:"boolean"}
python = True #@param {type:"boolean"}
java = True #@param {type:"boolean"}
C = True #@param {type:"boolean"}
C_plus_plus = True #@param {type:"boolean"}
other_programming_langauges = True #@param {type:"boolean"}
data_structures_and_algorithms = True #@param {type:"boolean"}
arduino = True #@param {type:"boolean"}
raspberry_pi = True #@param {type:"boolean"}
...
natural_language_processing = True #@param {type:"boolean"}
computer_vision = True #@param {type:"boolean"}
wearable_devices = True #@param {type:"boolean"}
deep_learning = True #@param {type:"boolean"}
reinforcement_learning = True #@param {type:"boolean"}

#@title Why this Course
#@markdown `why_this_course` (1 pt): Why are you taking this course?
why_this_course = "I am considering getting the Masters Degree and I am familiar with Dr. Ahmed as a professor" #@param {type:"string"}
...
circumstances = "not applicable" #@param {type:"string"}
...
medium_email = "wholeonomics@gmail.com" #@param {type:"string"}
medium_display_name = "Boris Polania" #@param {type:"string"}
medium_username = "@wholenomics" #@param {type:"string"}
...
number_of_RPM = 45 #@param {type:"number"}
...
#@title Best RPM
best_RPM = 12.5 #@param {type:"number"}
...
FAVORITE_PART = "My favorite part was the Collatz Conjecture, I did this in the past, can't remember when but it was fun to try and do it again " #@param {type:"string"}

WENT_WELL = "It seems that I am at an ideal level to take the course so I was able to get up to date" #@param {type:"string"}

CHALLENGING = "First week was very busy for me, but now I was able to go through the lectures and the PS and I am up to date now" #@param {type:"string"}

COMMENTARY = "Good start!" #@param {type:"string"}
